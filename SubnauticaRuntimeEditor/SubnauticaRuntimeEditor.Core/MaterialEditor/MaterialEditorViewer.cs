...
namespace SubnauticaRuntimeEditor.Core.MaterialEditor
{
	public class MaterialEditorViewer : Window<MaterialEditorViewer>
	{
		...
		protected override void DrawContents()
		{
			...
			if (this.editingMaterial.shader.name.Equals(MaterialEditorViewer.MARMOSETUBER_SHADER_NAME))
			{
				...
				{
					this.materialKeywordsExpanded = !this.materialKeywordsExpanded;
				}
				if (this.materialKeywordsExpanded)
				{
					this.DrawKeywords();
				}
			...
			{
				this.materialPropertiesExpanded = !this.materialPropertiesExpanded;
			}
			if (this.materialPropertiesExpanded)
			{
				this.DrawProperties();
			}
			GUILayout.EndVertical();
