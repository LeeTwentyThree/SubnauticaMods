        ...
        public static void SaveTextureToFileWithDialog(this Texture texture)
        {
            ...
            try
            {
                ...
                if (data != null)
                {
                    ...
                    {
                        SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Debug, "Writing encoded texture data to file at " + filename[0]);
            ...
            {
                SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Error | LogLevel.Message,
                    "Could not encode texture to PNG. Reason: " + e.Message);
                SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Error, e.StackTrace);
            }
        }
