...
using HarmonyLib;
using SubnauticaRuntimeEditor.Core.Clipboard;
...
namespace SubnauticaRuntimeEditor.Core.Inspector
{
    internal static class VariableFieldDrawer
    {
        ...
        private static readonly int _currentlyInvokingWindowId = Core.SubnauticaRuntimeEditorCore.Version.GetHashCode() + 80085;
