...
namespace SubnauticaRuntimeEditor.Core.Inspector
{
    public sealed partial class Inspector : Window<Inspector>
    {
        ...
        protected override void DrawContents()
        {
            ...
            foreach (var tab in _tabs.ToList())
            {
                ...
                {
                    SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Message, $"[{Title}] Removed invalid/removed stack object: \"{tab.InspectorStack.Peek().Name}\"");
                    tab.Pop();
                }
                ...
                if (_tabs.Count >= 2)
                {
                        ...
                        GUI.skin.horizontalScrollbar, GUIStyle.none, GUIStyle.none); //, GUILayout.Height(46)
                    {
                        ...
                        for (var index = 0; index < _tabs.Count; index++)
                        {
                            ...
                            if (currentTab == tab)
                                GUI.backgroundColor = Styling.Colors.inspectorTabSelectedColor;
