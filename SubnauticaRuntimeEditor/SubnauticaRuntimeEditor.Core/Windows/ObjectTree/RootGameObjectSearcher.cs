...
namespace SubnauticaRuntimeEditor.Core.ObjectTree
{
    ...
    public class RootGameObjectSearcher
    {
        ...
        public void Refresh(bool full, Predicate<GameObject> objectFilter)
        {
            ...
            if (full)
            {
                SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Debug, $"Full GameObject list refresh finished in {sw.ElapsedMilliseconds}ms");
        ...
        public void Search(string searchString, bool searchProperties, bool searchResources, bool refreshObjects = true)
        {
            ...
            if (!string.IsNullOrEmpty(searchString))
            {
                ...
                SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Info, searchProperties ? $"Deep searching for [{searchString}], this can take a while..." : $"Searching for [{searchString}]");
                ...
                SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Info, $"Search finished in {sw.ElapsedMilliseconds}ms");
            }
        }
