...
using SubnauticaRuntimeEditor.Core.Utils.ObjectDumper;
using UnityEngine;
...
namespace SubnauticaRuntimeEditor.Core.REPL
{
    public class REPL : InteractiveBase
    {
        static REPL()
        {
            ...
            go.transform.parent = SubnauticaRuntimeEditorCore.PluginObject.transform;
        ...
        {
            return SubnauticaRuntimeEditorCore.Instance.Inspector.GetInspectedObject()
        ...
        {
            if (obj == null) throw new ArgumentNullException(nameof(obj));
            SubnauticaRuntimeEditorCore.Instance.Inspector.Push(new InstanceStackEntry(obj, "REPL > " + obj.GetType().Name), true);
        }
        ...
        public static void setis(Type type)
        {
            ...
            SubnauticaRuntimeEditorCore.Instance.Inspector.Push(new StaticStackEntry(type, "REPL > " + type.Name), true);
        }

        [Documentation("getTree() - get the transform currently selected in tree view.")]
        public static Transform getTree()
        {
            return SubnauticaRuntimeEditorCore.Instance.TreeViewer.SelectedTransform;
        }
        ...
        public static void findTree(Transform tr)
        {
            ...
            SubnauticaRuntimeEditorCore.Instance.TreeViewer.SelectAndShowObject(tr);
        }
        ...
        public static void findTree(GameObject go)
        {
            ...
            SubnauticaRuntimeEditorCore.Instance.TreeViewer.SelectAndShowObject(go.transform);
        }
        ...
        {
            SubnauticaRuntimeEditorCore.Instance.Repl.AppendLogLine(message);
        }

        [Documentation("message(string) - write a string to log.")]
        public static void message(string message)
        {
            SubnauticaRuntimeEditorCore.Logger.Log(LogLevel.Message, message);
        }
