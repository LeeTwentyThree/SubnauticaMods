...
{
	public static void CreateMesh(ref Mesh mesh, Vector3 meshCenter, Vector3[] points, int resolutionU = 10, float thickness = 2)
	{
		...
		for (int s = 0; s < numCircles; s++)
		{
			...
			Vector3 centerPos = points[s] - meshCenter;
